...
### Epilogue ###
Overall, I like this final project very much. It took much longer time than I expected, but it is very rewarding. I learned very much not only on data visualization, but also on data format and munging. In other words, my data analytics skill has been improved from this final project. It was so much fun, because I could see how my data look like visually and felt happy by seeing them getting prettier and prettier. I got to know `shiny` and `ggplot2` more for sure and `plyr` as well. I learend much on the color scheme as well. I would like to show my appreciation to [Sophie](https://github.com/sjengle) and my classmates. If it were not them, my final project would be not as good as what it is now. Thanks a lot for giving me wonderful feedback and advices. I feel blessed to know you all.
